      ...
      <div className='w-12/12 sm:w-11/12 md:w-7/12 h-full relative mx-auto'>
        <div className='w-6/12 h-full absolute right-0 flex justify-end px-5'>
            <button className='h-[60px] w-[40px] scale-100'>
              {onTop? <svg className='mx-2' width="50%" height="50%" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              </svg> : <svg className='mx-2' width="50%" height="50%" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className='h-[60px] w-[40px] aspect-square scale-50'>
              {onTop? <svg width="100%" height="100%" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12.7501 5.00684C12.7501 7.0779 11.0712 8.75684 9.00009 8.75684C6.92902 8.75684 5.25009 7.0779 5.25009 5.00684C5.25009 2.93577 6.92902 1.25684 9.00009 1.25684C11.0712 1.25684 12.7501 2.93577 12.7501 5.00684Z" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M1.50122 19.1251C1.57153 15.0437 4.90196 11.7568 9.00009 11.7568C13.0983 11.7568 16.4288 15.0439 16.499 19.1254C14.2162 20.1729 11.6765 20.7568 9.00041 20.7568C6.32408 20.7568 3.78418 20.1727 1.50122 19.1251Z" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>:<svg width="100%" height="100%" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12.7501 5.00684C12.7501 7.0779 11.0712 8.75684 9.00009 8.75684C6.92902 8.75684 5.25009 7.0779 5.25009 5.00684C5.25009 2.93577 6.92902 1.25684 9.00009 1.25684C11.0712 1.25684 12.7501 2.93577 12.7501 5.00684Z" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M1.50122 19.1251C1.57153 15.0437 4.90196 11.7568 9.00009 11.7568C13.0983 11.7568 16.4288 15.0439 16.499 19.1254C14.2162 20.1729 11.6765 20.7568 9.00041 20.7568C6.32408 20.7568 3.78418 20.1727 1.50122 19.1251Z" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>}
            </button>
            <button className='h-[60px] w-[40px] aspect-square scale-50'>
